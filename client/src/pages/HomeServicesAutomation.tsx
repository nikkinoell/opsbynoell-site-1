...
export default function HomeServicesAutomation() {
  return (
    <div style={{ backgroundColor: '#010509', minHeight: '100vh' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, paddingTop: 'clamp(2rem, 4vw, 2.5rem)', textAlign: 'center', paddingBottom: '5.5rem' }}>
          <div style={{ marginBottom: '1.5rem' }}><SectionBadge>Home Services Automation</SectionBadge></div>
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <a href={BOOKING_LINK} target="_blank" rel="noreferrer" className="btn-gradient" style={{ padding: '1rem 2rem', fontSize: '1rem', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            {serviceDetails.map((svc, i) => (
              <div className="reveal">
                <div style={{ padding: '2.25rem', background: 'rgba(167,139,250,0.03)', border: '1px solid rgba(167,139,250,0.12)', borderRadius: '12px', height: '100%' }}>
                  ...
                  <h3 style={{ fontFamily: "'Nicholas', serif", fontSize: '1.1875rem', fontWeight: 600, color: '#ffffff', marginBottom: '0.75rem' }}>{svc.title}</h3>
      ...
      {/* ── STAT BLOCK ── */}
      <div className="reveal">
      <section style={{ padding: 'clamp(2rem, 5vw, 5rem) 0', background: 'rgba(167,139,250,0.03)', borderTop: '1px solid rgba(167,139,250,0.08)', borderBottom: '1px solid rgba(167,139,250,0.08)' }}>
        <div className="container">
          <div className="reveal">
            ...
            {stats.map((s, i) => (
              <div className="reveal">
                <div style={{ padding: '2rem', background: '#010509', border: '1px solid rgba(167,139,250,0.15)', borderRadius: '12px', textAlign: 'center' }}>
                  <div style={{ fontFamily: "'Nicholas', serif", fontSize: 'clamp(1.375rem, 4vw, 2.5rem)', fontWeight: 800, color: '#A78BFA', lineHeight: 1, marginBottom: '0.75rem', letterSpacing: '-0.03em' }}>{s.num}</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', maxWidth: '960px', margin: '0 auto 4rem' }}>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.02)', border: '1px solid rgba(167,139,250,0.12)', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.6875rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#A78BFA', marginBottom: '0.75rem' }}>Entry</div>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.3)', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column', position: 'relative' }}>
                ...
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.6875rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#A78BFA', marginBottom: '0.75rem' }}>Starter</div>
                <div style={{ marginBottom: '0.5rem' }}>
                ...
                <a href={BOOKING_LINK} target="_blank" rel="noreferrer" className="btn-gradient" style={{ textAlign: 'center', padding: '0.875rem 1.5rem', fontSize: '0.9375rem', display: 'block', fontWeight: 600 }}>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.02)', border: '1px solid rgba(167,139,250,0.12)', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.6875rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#A78BFA', marginBottom: '0.75rem' }}>Growth</div>
                <div style={{ marginBottom: '0.5rem' }}>
      ...
      <section style={{ position: 'relative', padding: 'clamp(2.5rem, 6vw, 7rem) 0', borderTop: '1px solid rgba(167,139,250,0.08)', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '680px', margin: '0 auto' }}>
          <div className="reveal">
            ...
            <a href={BOOKING_LINK} target="_blank" rel="noreferrer" className="btn-gradient" style={{ padding: '1.125rem 2.25rem', fontSize: '1.0625rem', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
