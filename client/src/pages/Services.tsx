    ...
    <div style={{ backgroundColor: '#010509', minHeight: '100vh' }}>
              ...
              <FadeItem key={number} delay={i * 0.06}>
                <div className="feature-card" style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1rem', height: '100%', boxSizing: 'border-box' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <h3 style={{ fontFamily: "'Nicholas', serif", fontSize: '1.0625rem', fontWeight: 700, color: '#ffffff', lineHeight: 1.25, margin: 0 }}>{title}</h3>
                  </div>
                  <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.9rem', color: '#b8b6b3', lineHeight: 1.65, margin: 0 }}>{desc}</p>
                  <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.8125rem', fontWeight: 600, color: '#A78BFA', margin: 0 }}>{stat}</p>
                  <a href={href} style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.8125rem', fontWeight: 600, color: '#C4B5FD', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.3rem', marginTop: 'auto' }}>
      ...
      <section style={{ padding: '6rem 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '1.0625rem', color: '#b8b6b3', maxWidth: '500px', margin: '0 auto', lineHeight: 1.7 }}>
              ...
              <FadeItem key={name} delay={i * 0.07}>
                <a href={href} style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
                  <div className="feature-card" style={{ padding: '2rem', height: '100%', display: 'flex', flexDirection: 'column', gap: '1rem', cursor: 'pointer', transition: 'border-color 0.2s ease', boxSizing: 'border-box' }}>
                    ...
                    <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.9rem', color: '#b8b6b3', lineHeight: 1.7, flex: 1 }}>{desc}</p>
              ...
              <FadeItem key={name} delay={i * 0.1}>
                <div className={featured ? 'pricing-card featured' : 'pricing-card'} style={{ padding: '2rem', position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <div style={{ marginTop: featured ? '1rem' : 0, flex: 1 }}>
                    ...
                    <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.75rem', fontWeight: 600, color: '#C4B5FD', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '1rem' }}>{subtitle}</p>
            ...
            <div key={i} className="faq-item">
              ...
              {openFaq === i && (
                <div style={{ paddingBottom: '1.5rem' }}>
                  <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.9375rem', color: '#b8b6b3', lineHeight: 1.75 }}>{a}</p>
                </div>
              )}
            </div>
          ))}
      ...
      <section style={{ padding: '7rem 0', textAlign: 'center', position: 'relative', overflow: 'hidden', borderTop: '1px solid rgba(167,139,250,0.08)' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '660px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '1.0625rem', color: '#b8b6b3', maxWidth: '480px', margin: '0 auto 2.5rem', lineHeight: 1.75 }}>
          ...
          <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.8125rem', color: '#b8b6b3', marginTop: '1.25rem' }}>No commitment. No credit card. Just a conversation.</p>
