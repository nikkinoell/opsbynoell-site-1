...
const pageMeta: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  "/nova": {
    title: "Nova AI Chat Agent for Your Website | Ops by Noell",
    description:
      "Nova is an AI chat agent that qualifies visitors, captures contact info, and sends instant lead alerts. Done for you. Live on your site in 48 hours. $997 setup, $297/month.",
    keywords:
      "Nova AI chat agent, website lead capture, AI chat for service businesses, done-for-you chat agent, instant lead alerts, AI receptionist website, Orange County, Ops by Noell Nova",
  },
};
